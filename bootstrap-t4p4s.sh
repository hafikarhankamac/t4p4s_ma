...
REPO_PATH_p4c=${REPO_PATH_p4c-"https://gitlab+deploy-token-265:wnCdz_rZqesV4iYAGw9b@gitlab.lrz.de/p4/tapas/p4c.git"}
...
REPO_PATH_t4p4s=${REPO_PATH_t4p4s-"https://gitlab+deploy-token-247:-K1yHEhTvygwQsCiJ8tG@gitlab.lrz.de/p4/tapas/t4p4s.git}
