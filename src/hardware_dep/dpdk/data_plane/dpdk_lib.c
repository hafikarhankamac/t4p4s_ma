...
uint64_t topbits_8(uint64_t data, int bits) { return data >> (64 - bits); }
...
uint64_t net2t4p4s_8(uint64_t data) { return rte_be_to_cpu_64(data); }
...
uint64_t t4p4s2net_8(uint64_t data) { return rte_cpu_to_be_64(data); }
